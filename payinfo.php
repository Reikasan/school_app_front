...
<div class="container">
    <ul class="nav nav-tabs mt-3" id="monthTab" role="tablist">
        ...
        <li class="nav-item col-2" role="presentation">
            <button class="col-12 nav-link" id="another-tab" data-bs-toggle="tab" data-bs-target="#another-tab-pane" type="button" role="tab" aria-controls="another-tab-pane" aria-selected="false">+</button>
        </li>
    </ul>
    <div class="tab-content" id="payMonth">
                        ...
                        <div class="accordion-body position-relative">
                            <ul class="list-group list-group-flush position-relative">
                                ...
                                <li class="list-group-item row">
                                    ...
                                    <input type="number" name="" id="" class="form-control payforThisMonth" value="0"><label class="col-form-label col-2">Lesson</label>
                                </li>
        ...
        <div class="tab-pane fade" id="another-tab-pane" role="tabpanel" aria-labelledby="another-tab" tabindex="0">
            <?php include "includes/search_month.php"; ?>
        </div>
    </div>
